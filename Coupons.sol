...
contract Web3ClubTourToken is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("TestContract20220820Coupon", "202208200753Coupon") {}

    function safeMint(address to, string memory uri) public onlyOwner {
        //once it is minted we define everything that is needed to be stored in the json file. this file will be on IPFS.
